...
from app.services.robot_config import robot_config_crud
...
@router.post("/queryByPageWithFilter", response_model=ResponseModel)
async def query_by_page_with_filter(
    *,
    ...
    try:
        ...
        return RespModel.success(data=datas, total=total, msg="查询成功")
