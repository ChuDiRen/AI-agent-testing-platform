...
const dialogTitle = computed(() => (formData.id ? '编辑WEB测试用例' : '新增WEB测试用例'))
...
const handleBatchExport = () => {
  ...
  const success = exportTestCasesToExcel(selectedRows.value, 'WEB测试用例')
  if (success) {
