...
export const ImportApiModal: React.FC<ImportApiModalProps> = ({ open, onCancel, onImport }) => {
  ...
  const items = [
    ...
    },
    {
      ...
      children: (
        <div className="mt-4">
          <Upload.Dragger {...uploadProps} className="bg-slate-900/50 border-slate-700 hover:border-neon-cyan">
            <p className="ant-upload-drag-icon flex justify-center text-neon-cyan mb-2">
              <UploadIcon size={32} />
            </p>
