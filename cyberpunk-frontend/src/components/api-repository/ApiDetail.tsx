...
const SchemaViewer: React.FC<{ schema?: ApiSchema }> = ({ schema }) => {
  ...
  return (
    <div className="bg-slate-900/50 p-4 rounded-lg border border-slate-700/50 font-mono text-sm">
      <div className="mb-2 text-slate-400">Type: <span className="text-neon-cyan">{schema.type}</span></div>
      {schema.properties && (
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
             ...
             <div className="flex gap-3 flex-row-reverse">
              ...
              <div className="bg-neon-cyan/20 p-3 rounded-lg rounded-tr-none border border-neon-cyan/30">
                <Paragraph className="mb-0 text-slate-300">
