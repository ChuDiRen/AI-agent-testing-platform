  ...
  const columns = [
    {
      ...
      render: (_: unknown, record: TeamMember) => (
        <div className="flex items-center gap-3">
          <Avatar src={record.avatar || undefined} icon={!record.avatar && <Users size={16} />} className="bg-slate-700" />
    ...
    },
    {
      ...
      render: (_: unknown, record: TeamMember) => (
        <Select
          ...
          styles={{ popup: { root: { backgroundColor: '#1e293b', border: '1px solid #334155' } } }}
        >
          <Option value="Admin">
        ...
        <div className="space-y-4 mt-4">
          ...
          <div>
            ...
            <Select 
              ...
              className="w-full"
              styles={{ popup: { root: { backgroundColor: '#0f172a', border: '1px solid #1e293b' } } }}
            >
               <Option value="Admin">
