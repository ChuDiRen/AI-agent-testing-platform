...
setup(
    name="mobile-engine",
    version="1.0.0",
    description="Mobile 自动化测试引擎 - 基于 Appium 的关键字驱动和数据驱动测试框架",
    author="ChuDiRen",
    author_email="",
    ...
    entry_points={
        "console_scripts": [
            "mobilerun=mobilerun.cli:run",
        ],
    },
    keywords="appium mobile android ios automation testing keyword-driven data-driven",
    project_urls={
