...
export default {
  // 认证相关 - 使用现有的users接口
  login: (data) => request.post('/users/login', data, { noNeedToken: true }),
  getUserInfo: (data) => request.post('/users/get-user-info', data),
  getUserMenu: () => request.post('/menus/get-user-menus', {}),
  getUserApi: () => request.post('/permissions/get-user-permissions', {}),
