...
- [x] 1. Set up LangGraph module structure
  ...
  - [ ] 1.2 Create state and base agent definitions
...
- [ ] 2. Implement ModelService for domestic AI models
  ...
  - [ ]* 2.2 Write property test for provider URL auto-fill
...
- [x] 4. Implement Supervisor and Generator
  ...
  - [ ] 4.2 Implement TestCaseGenerator
...
- [ ] 7. Implement LangGraphController API
  ...
  - [ ]* 7.2 Write property test for SSE event sequence
    - **Property 3: SSE Event Sequence**
    - **Validates: Requirements 2.1, 2.2, 2.3, 2.4, 2.5**
  - [ ] 7.3 Implement batch generation endpoint
...
- [ ] 10. Implement error handling and recovery
  - [ ] 10.1 Implement error handling in agents
...
- [ ] 11. Implement export functionality
  - [ ] 11.1 Implement YAML export
    - Add export_yaml() method in TestCaseController
    - _Requirements: 4.4_
  - [ ]* 11.2 Write property test for export format validity
    - **Property 8: Export Format Validity**
    - **Validates: Requirements 4.4**

- [ ] 12. Register routes in app.py
...
- [x] 14. Implement AgentChatEnhanced page
  ...
  - [ ] 14.2 Implement useLangGraph composable
