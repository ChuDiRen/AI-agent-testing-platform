...
export const testReportApi = {
  ...
  createTestReport(data: TestReportCreateRequest) {
    return http.post<TestReportResponse>('/api/v1/test-reports/', data)
  },
  ...
  getTestReport(id: number) {
    return http.get<TestReportResponse>(`/api/v1/test-reports/${id}`)
  },
  ...
  updateTestReport(id: number, data: Partial<TestReportInfo>) {
    return http.put<TestReportResponse>(`/api/v1/test-reports/${id}`, data)
  },
  ...
  deleteTestReport(id: number) {
    return http.delete(`/api/v1/test-reports/${id}`)
  },
  ...
  getTestReportList(params: { 
    ...
    return http.get<TestReportListResponse>('/api/v1/test-reports/', { params })
  },
  ...
  searchTestReports(params: { 
    ...
    return http.post<TestReportListResponse>('/api/v1/test-reports/search', params)
  },
  ...
  getStatistics(params: {
    ...
    return http.get<TestReportStatisticsResponse>('/api/v1/test-reports/statistics', { params })
  },
  ...
  generateReport(data: {
    ...
    }>('/api/v1/test-reports/generate', data)
  },
  ...
  getGenerationTask(taskId: string) {
    ...
    }>(`/api/v1/test-reports/tasks/${taskId}`)
  },
  ...
  cancelGenerationTask(taskId: string) {
    return http.post(`/api/v1/test-reports/tasks/${taskId}/cancel`)
  },
  ...
  exportTestReport(reportId: number, format: 'pdf' | 'excel' | 'html' | 'json' = 'pdf') {
    return http.get(`/api/v1/test-reports/${reportId}/export`, {
      params: { format },
      responseType: 'blob'
    })
  },
  ...
  batchExportReports(data: {
    ...
    return http.post('/api/v1/test-reports/batch/export', data, {
      responseType: 'blob'
    })
  },
  ...
  rerunTestReport(reportId: number, options?: {
    ...
    }>(`/api/v1/test-reports/${reportId}/rerun`, options || {})
  },
  ...
  getTrendData(params: {
    ...
    }>('/api/v1/test-reports/trends', { params })
  },
  ...
  getReportDetails(reportId: number) {
    ...
    }>(`/api/v1/test-reports/${reportId}/details`)
  }
}