...
@module_route.get("/queryById") # 根据ID查询API项目
...
@module_route.post("/insert") # 新增API项目
...
@module_route.put("/update") # 更新API项目
...
@module_route.delete("/delete") # 删除API项目
...
@module_route.get("/queryAll") # 查询所有API项目
