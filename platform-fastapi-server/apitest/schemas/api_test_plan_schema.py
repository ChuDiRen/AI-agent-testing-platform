...
# ==================== 测试计划查询相关 ====================
class ApiTestPlanQuery(BaseModel):
    """测试计划查询请求"""
...
# ==================== 测试计划创建/更新相关 ====================
class ApiTestPlanCreate(BaseModel):
    """测试计划创建请求"""
    project_id: Optional[int] = Field(default=None, description="项目ID")
...
# ==================== 计划用例关联相关 ====================
class ApiPlanCaseCreate(BaseModel):
    """计划用例关联创建请求"""
...
# ==================== 测试计划详情相关 ====================
class ApiTestPlanWithCases(BaseModel):
    """测试计划详情响应（含关联用例）"""
    id: int
    ...
    cases: List[ApiPlanCaseResponse] = Field(default=[], description="关联的用例列表")
...
# ==================== 测试计划执行相关 ====================
class ApiTestPlanExecuteRequest(BaseModel):
    """测试计划执行请求"""
    plan_id: int = Field(description="测试计划ID")
    test_name: Optional[str] = Field(default=None, description="测试名称")

class ApiTestPlanExecuteResponse(BaseModel):
    """测试计划执行响应"""
