...
class AiGenerateHistory(SQLModel, table=True):
    ...
    requirement_text: str = Field(sa_column_kwargs={"type_": "TEXT"})  # 用户需求文本
    ...
    result_data: Optional[str] = Field(default=None, sa_column_kwargs={"type_": "LONGTEXT"})  # 生成的结果数据（JSON格式）
