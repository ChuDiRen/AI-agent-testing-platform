...
@module_route.post("/queryByPage", summary="分页查询用户", dependencies=[Depends(check_permission("system:user:query"))]) # 分页查询用户
...
@module_route.get("/queryById", summary="根据ID查询用户", dependencies=[Depends(check_permission("system:user:query"))]) # 根据ID查询用户
...
@module_route.post("/insert", summary="新增用户", dependencies=[Depends(check_permission("system:user:add"))]) # 新增用户
...
@module_route.put("/update", summary="更新用户", dependencies=[Depends(check_permission("system:user:edit"))]) # 更新用户
...
@module_route.delete("/delete", summary="删除用户", dependencies=[Depends(check_permission("system:user:delete"))]) # 删除用户
