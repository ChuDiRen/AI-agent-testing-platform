...
export const RagKnowledgeBase: React.FC = () => {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <Row gutter={16}>
        <Col span={8}>
          <Card bordered={false} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50">
            <Statistic 
        ...
        <Col span={8}>
          <Card bordered={false} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50">
            <Statistic 
              ...
              valueStyle={{ color: indexingCount > 0 ? '#60a5fa' : errorCount > 0 ? '#f87171' : '#34d399', fontSize: '1.5rem' }}
      ...
      >
        ...
        >
          <p className="ant-upload-drag-icon">
            <Inbox className="text-indigo-500 mx-auto" size={48} />
          </p>
