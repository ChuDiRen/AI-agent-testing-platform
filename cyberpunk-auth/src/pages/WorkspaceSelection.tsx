        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
          {mockWorkspaces.map((workspace) => (
            <div
              ...
              className="group relative p-6 rounded-xl border border-slate-700/50 bg-slate-800/50 backdrop-blur-sm cursor-pointer transition-all duration-300 hover:border-indigo-500/50 hover:shadow-[0_0_20px_rgba(99,102,241,0.15)] hover:-translate-y-1"
            >
              <div className="flex items-start justify-between mb-4">
                <Avatar 
                  ...
                  size={48} 
                  src={workspace.icon} 
                  className="rounded-lg border border-slate-600 group-hover:border-indigo-500/50 transition-colors"
                />
          ...
          <button className="group flex flex-col items-center justify-center p-6 rounded-xl border-2 border-dashed border-slate-700 bg-slate-800/20 hover:bg-slate-800/40 hover:border-indigo-500/50 transition-all duration-300 min-h-[220px]">
            <div className="w-16 h-16 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center mb-4 group-hover:border-indigo-500/50 group-hover:bg-indigo-500/10 transition-all">
              <Plus className="w-8 h-8 text-slate-400 group-hover:text-indigo-400" />
            </div>
            <h3 className="text-lg font-semibold text-slate-300 group-hover:text-indigo-400 transition-colors">
