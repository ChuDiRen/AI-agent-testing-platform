        ...
        <div className="space-y-6">
          ...
          <Card className="bg-slate-900/50 border-slate-800 backdrop-blur-sm">
            <div className="flex flex-col items-center text-center">
              ...
              <Tag color="geekblue" className="mt-3 border-none bg-indigo-500/10 text-indigo-400">
                {user.role}
              </Tag>
              <Upload showUploadList={false}>
                <Button className="mt-6 border-slate-700 text-slate-300 hover:text-white hover:border-indigo-500">
                  Change Avatar
                </Button>
              </Upload>
            </div>
          ...
          <Card className="bg-slate-900/50 border-slate-800 backdrop-blur-sm" title={<span className="text-slate-200">Theme Preference</span>}>
            ...
            >
              <Radio.Button 
                value="system" 
                className={`flex flex-col items-center justify-center h-24 border-slate-700 bg-slate-950/50 ${theme === 'system' ? '!border-indigo-500 !text-indigo-400' : 'text-slate-500'}`}
              >
              ...
              <Radio.Button 
                value="light" 
                className={`flex flex-col items-center justify-center h-24 border-slate-700 bg-slate-950/50 ${theme === 'light' ? '!border-indigo-500 !text-indigo-400' : 'text-slate-500'}`}
              >
              ...
              <Radio.Button 
                value="dark" 
                className={`flex flex-col items-center justify-center h-24 border-slate-700 bg-slate-950/50 ${theme === 'dark' ? '!border-indigo-500 !text-indigo-400' : 'text-slate-500'}`}
              >
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Form.Item label={<span className="text-slate-400">Full Name</span>} name="name" rules={[{ required: true }]}>
                  <Input className="bg-slate-950 border-slate-700 text-slate-200 focus:border-indigo-500" />
                </Form.Item>
                <Form.Item label={<span className="text-slate-400">Email</span>} name="email" rules={[{ required: true, type: 'email' }]}>
                  <Input className="bg-slate-950 border-slate-700 text-slate-200 focus:border-indigo-500" suffix={<Mail size={16} className="text-slate-600" />} />
                </Form.Item>
              </div>
              <Form.Item label={<span className="text-slate-400">Bio</span>} name="bio">
                <Input.TextArea rows={4} className="bg-slate-950 border-slate-700 text-slate-200 focus:border-indigo-500" />
              </Form.Item>
