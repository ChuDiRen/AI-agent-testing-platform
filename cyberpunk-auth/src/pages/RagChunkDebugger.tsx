      ...
      <div className="flex justify-between items-center shrink-0">
        <div>
          <h1 className="text-2xl font-bold text-slate-100 flex items-center gap-3">
            <Highlighter className="text-indigo-500" />
            RAG 块调试器
          </h1>
        ...
        <div className="w-1/2 flex flex-col gap-4 min-h-0">
          ...
          <div className="shrink-0">
            <Input 
              ...
              className="bg-slate-900/80 border-slate-700 text-slate-200 h-12 text-lg focus:border-indigo-500"
              allowClear
            />
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-3 flex justify-between items-center">
                    ...
                    {isSelected && (
                       <Button type="link" size="small" className="text-indigo-400 p-0 h-auto flex items-center gap-1">
