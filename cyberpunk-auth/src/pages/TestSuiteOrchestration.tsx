...
export const TestSuiteOrchestration: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: string) => (
        <Space size={4}>
          {text === 'Manual' ? <Play size={14} className="text-slate-500" /> : <Clock size={14} className="text-indigo-400" />}
      ...
      <Modal
        ...
        footer={
          <div className="flex justify-between w-full">
             ...
             {currentStep < 2 ? (
               <Button type="primary" onClick={handleNext} className="bg-indigo-600">
                 Next
               </Button>
             ) : (
          ...
          <div className="space-y-6">
            ...
            <Descriptions column={1} layout="vertical" className="bg-slate-800/30 p-4 rounded-lg">
              ...
              <Descriptions.Item label={<span className="text-slate-500">Schedule</span>}>
                <span className="text-indigo-400 font-mono">{selectedSuite.schedule}</span>
              </Descriptions.Item>
