  ...
  const columns = [
    {
      ...
      render: (text: string, record: EnvVariable) => (
        <Input 
          ...
          className="font-mono text-slate-300 bg-slate-900/50 border-slate-700 focus:border-indigo-500"
        />
      ),
    },
    {
    ...
    },
    {
      ...
      render: (text: string, record: EnvVariable) => (
        <Input 
          ...
          className="text-slate-400 bg-slate-900/50 border-slate-700 focus:border-indigo-500"
        />
      ),
    },
    {
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center mb-4">
        <Space>
           <Upload beforeUpload={handleImport} showUploadList={false} accept=".env">
             <Button icon={<UploadIcon size={16} />} className="border-slate-600 text-slate-300 hover:text-indigo-400 hover:border-indigo-400">
               Import .env
             </Button>
           </Upload>
           <Button icon={<Download size={16} />} onClick={handleExport} className="border-slate-600 text-slate-300 hover:text-indigo-400 hover:border-indigo-400">
             Export
           </Button>
        </Space>
        <Button type="primary" icon={<Save size={16} />} className="bg-indigo-600 hover:bg-indigo-500 border-none">
          Save Changes
        </Button>
      </div>
      ...
      <Button 
        ...
        onClick={handleAdd} 
        icon={<Plus size={16} />}
        className="mt-4 border-slate-700 text-slate-400 hover:text-indigo-400 hover:border-indigo-400 bg-slate-800/30"
      >
        Add Variable
      </Button>
